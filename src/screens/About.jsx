  ...
  <div className="about-page">
    ...
    <div className="second-container">
      <div>
        ...
        <span>
          <p>
            Universitário, autodidata em programação e inglês, e, graças a Deus,
            católico. Com grande gosto pelo desenvolvimento web e mobile com
            JavaScript, principalmente com as tecnologias envolvidas com NodeJS
            e React, é o que tem me feito dedicar grande parte do meu dia-a-dia
            estudando.
          </p>
        </span>
      </div>
      ...
      <div>
        ...
        <span>
          ...
          <p>Em 2015, concluí o Ensino fundamental.</p>
        </span>
      </div>
      ...
      <div>
        ...
        <span>
          <p>
            ...
            Onde pude começar a criar um aplicativo em Ionic que foi em recriado
            em ReactNative. Foram 2 meses de testes, de 08/19 até 10/19, com uma
            equipe de 4 pessoas numa startup.
          </p>
        </span>
      </div>
    </div>
